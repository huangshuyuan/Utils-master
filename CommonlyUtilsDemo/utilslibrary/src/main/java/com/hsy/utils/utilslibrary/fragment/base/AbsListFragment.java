package com.hsy.utils.utilslibrary.fragment.base;
...
import com.hsy.utils.utilslibrary.view.loadmore.LoadMoreWrapper;
...
public abstract class AbsListFragment extends LazyLoadFragment implements IList {
    ...
    public MultiTypeAdapter getmMultiTypeAdapter() {
