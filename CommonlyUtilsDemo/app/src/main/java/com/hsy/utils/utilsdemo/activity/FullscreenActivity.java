...
//    AppBarLayout appBarLayout;
    ...
    protected void setUpView() {
        mVisible = true;
        mControlsView = $(R.id.fullscreen_content_controls);
        mContentView = $(R.id.fullscreen_content);
//        toolbar = (Toolbar) $(R.id.toolbar);
//        setSupportActionBar(toolbar);
//        appBarLayout=(AppBarLayout)$(R.id.app_bar);
        ...
        $(R.id.dummy_button).setOnClickListener(new View.OnClickListener() {
            @Override
